...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const paper_1 = __importDefault(__webpack_require__(/*! paper */ "./node_modules/paper/dist/paper-full.js"));
const brush_1 = __importDefault(__webpack_require__(/*! ./tools/brush */ "./tools/brush.ts"));
window.onload = function () {
    // Initialize canvas
    const canvas = document.getElementById('canvas');
    paper_1.default.setup(canvas);
    const tool = brush_1.default();
    paper_1.default.tool = tool;
};
...
function createBrushTool() {
    let path;
    const tool = new paper_1.default.Tool();
    tool.minDistance = 1;
    var t = [];
    ...
    function onMouseUp(event) {
        ...
        for (let i = 1; i < x.length; i++) {
            ...
            if (D > S) {
                ...
                Sy.push(y[i]);
                D = 0;
                var circle = new paper_1.default.Shape.Circle(new paper_1.default.Point(x[i], y[i]), 3);
                circle.fillColor = new paper_1.default.Color('black');
            }
        }
        // Compute Straws!
        for (let i = w; i < Sx.length - w; i++) {
            var strawStart = new paper_1.default.Point(Sx[i - w], Sy[i - w]);
            var strawEnd = new paper_1.default.Point(Sx[i + w], Sy[i + w]);
            var newStraw = new paper_1.default.Path.Line(strawStart, strawEnd);
        ...
        var strawMed = getMedian_1.default(sortedStraw);
        // Set threshold
...
exports.default = createBrushTool;
